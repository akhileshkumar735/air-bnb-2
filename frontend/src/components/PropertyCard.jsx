  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 line-clamp-2 min-h-[32px] mb-4 font-medium">
          {listing.title}
        </p>
        ...
        <div className="mt-auto pt-3 border-t border-slate-100 dark:border-slate-800/40 flex items-center justify-between">
          <div>
            <div className="flex items-baseline space-x-1">
              ...
              <span className="text-[11px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">/ night</span>
            </div>
            {showTax ? (
              <span className="text-[9px] text-emerald-600 dark:text-emerald-400 font-bold block mt-0.5 uppercase tracking-wider">includes 18% GST</span>
            ) : (
              <span className="text-[9px] text-slate-400 dark:text-slate-500 font-semibold block mt-0.5 uppercase tracking-wider">+ 18% GST</span>
            )}
          </div>
